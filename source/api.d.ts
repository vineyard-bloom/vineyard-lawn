...
export declare function create_endpoint(app: express.Application, endpoint: Endpoint_Info, preprocessor?: Request_Processor | null, ajv?: null, listener?: RequestListener): void;
export declare function create_endpoint_with_defaults(app: express.Application, endpoint_defaults: Optional_Endpoint_Info, endpoint: Optional_Endpoint_Info, preprocessor?: Request_Processor | null): void;
export declare function create_endpoints(app: express.Application, endpoints: Endpoint_Info[], preprocessor?: Request_Processor | null, ajv?: null, listener?: RequestListener): void;
export declare function createEndpoints(app: express.Application, endpoints: Endpoint_Info[], preprocessor?: Request_Processor | null, ajv?: null, listener?: RequestListener): void;
