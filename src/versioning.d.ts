...
export declare function checkVersion(request: LawnRequest<any>, versions: Version[]): void;
export declare function applyVersioning<T>(versions: number[]): RequestTransform<T>;
